#!/usr/bin/env python3
"""Launch the local HPM-CAE V0.9 workbench."""
...
from hpm_platform.ui.app_v09 import launch


def main() -> None:
    parser = argparse.ArgumentParser(description="Launch HPM-CAE Workbench V0.9")
