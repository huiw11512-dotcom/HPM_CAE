...
- 当前快速验收：6/6 V&V 用例通过，可信度评分 91.58/A，全量 pytest 141 项通过。
...
- 新增 `/api/data-import/catalog`、`/api/data-import/acceptance`、`/api/data-import/calibration-readiness`、`/api/data-import/calibration-bridge`、`/api/data-import/model-comparison`、`/api/data-import/evidence-chain`、`/api/data-import/vv-audit`、`/api/data-import/samples/{sample_id}`、`/api/data-import/inspect`；
