...
from hpm_platform.ui.app_v20a import create_app  # noqa: E402
...
def main() -> None:
    ...
    uvicorn.run(create_app(args.project, args.output_dir), host=args.host, port=args.port, log_level="info")
